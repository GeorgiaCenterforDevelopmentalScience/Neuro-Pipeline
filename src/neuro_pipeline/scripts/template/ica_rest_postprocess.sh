...
subject="$1"
echo "Processing subject: $subject for ICA rest postprocessing"
...
in_dir="${output_dir}/${subj}/ses-${session}/ica_rest_output/${subj}.results"
in_dset="${in_dir}/${AFNI_DSET}.${subj}+tlrc"

out_dir="${output_dir}/${subj}/ses-${session}/ica_rest_output"
