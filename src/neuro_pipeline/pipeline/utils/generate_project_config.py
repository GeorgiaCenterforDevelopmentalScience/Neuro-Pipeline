...
def generate_project_config(project_name: str, output_dir: str = "./config/project_config"):
    config_template = {
        ...
        "setup": {
            ...
            "rest": [
                {"name": "rest_preprocess", "remove_TRs": 6, "template": "MNI152NLin2009cAsym", "container": "fmriprep_25.1.3.sif", "license": "license.txt"},
                {"name": "rest_post", "remove_TRs": 6, "template": "MNI152NLin2009cAsym", "container": "xcp_d-0.11.0rc1.sif", "rest_mode": "abcd", "motion_filter_type": "notch", "band_stop_min": "15", "band_stop_max": "25", "nuisance_regressors": "36P", "license": "license.txt"},
            ],
